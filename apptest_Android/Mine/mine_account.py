...
class MineTest(APP_pre.LoginTest):
    ...
    def test_04(self):
        ...
        # 更换输入的手机号为当前绑定的手机号
        time.sleep(50)
        # wait.countdown(self, element='com.zhongsu.online:id/btn_get_check_code', tip='发送验证码')
        self.driver.find_element_by_id('com.zhongsu.online:id/btn_get_check_code').click()
        self.driver.find_element_by_id('com.zhongsu.online:id/btn_submit').click()
        self.driver.implicitly_wait(20)
    ...
    def test_07(self):
        ...
        self.driver.find_element_by_id(
            'com.zhongsu.online:id/et_contact_phone').send_keys('188'+create_data.random_num(8))
        time.sleep(3)
        ...
        # 手机号为空不能保存
        self.driver.find_element_by_id(
            'com.zhongsu.online:id/et_contact_name').send_keys("测试" + create_data.random_num(1))
        ...
        self.assertEqual('请输入正确的手机号码', toast.get_toast_text(self, toast='请输入正确的手机号码'))
        self.driver.find_element_by_id('com.zhongsu.online:id/et_contact_phone').clear()
        self.driver.find_element_by_id('com.zhongsu.online:id/et_contact_phone').send_keys(130229988321)
        self.assertEqual('请输入正确的手机号码', toast.get_toast_text(self, toast='请输入正确的手机号码'))
        # 保存成功
        self.driver.find_element_by_id('com.zhongsu.online:id/et_contact_phone').clear()
        self.driver.find_element_by_id(
            'com.zhongsu.online:id/et_contact_phone').send_keys('188'+create_data.random_num(8))
        wait.wait_click(self, element='com.zhongsu.online:id/btn_confirm')
        self.assertEqual('添加成功', toast.get_toast_text(self, toast='添加成功'))
        # 编辑成功
        self.driver.implicitly_wait(20)
        self.driver.find_element_by_xpath(
            '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android'
            '.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/androidx.recyclerview.widget'
            '.RecyclerView/android.widget.RelativeLayout[1]/android.widget.LinearLayout/android.widget.TextView[3]').click()
        self.driver.implicitly_wait(20)
        self.driver.find_element_by_id('com.zhongsu.online:id/et_contact_phone').clear()
        self.driver.find_element_by_id(
            'com.zhongsu.online:id/et_contact_phone').send_keys('188' + create_data.random_num(8))
        ...
        # 删除成功
        self.driver.implicitly_wait(20)
        num1 = self.driver.find_elements_by_id('com.zhongsu.online:id/tv_contact_name')
        self.driver.find_element_by_xpath(
            '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android'
            '.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/androidx.recyclerview.widget'
            '.RecyclerView/android.widget.RelativeLayout[1]/android.widget.LinearLayout/android.widget.TextView['
            '2]').click()
        self.driver.implicitly_wait(20)
        self.driver.find_element_by_id('com.zhongsu.online:id/now_approve_tv').click()
        num2 = self.driver.find_elements_by_id('com.zhongsu.online:id/tv_contact_name')
        self.assertEqual(len(num1)-1, len(num2))
